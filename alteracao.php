        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mx-auto">
                    ...
                    <h1 class="">Alteração de Produtos</h1>
                   

                    <form action="alterar1.php?cod=<?= $codigo ?>" method="post">
                        <p>
                            Digite a descrição
                        ...
                        <p>
                            Digite o peso
                            <input type="decimal" name="peso" id="peso" class="form-control" value="<?= $peso ?>">
                        </p>

                        <p>
                            Digite a unidade de medida
                            <input type="text" name="unidade" id="unidade" class="form-control" value="<?= $unidade ?>">
                        </p>
                        <p>
                            Digite o total
                            <input type="decimal" name="total" id="total" class="form-control" value="<?= $total ?>">
                        </p>

                        <p>
                            <input type="submit" value="Alterar/Salvar" class="btn btn-success">
                            <input type="reset" value="Limpar" class="btn btn-warning">
                            <a href="inicio.php" class="btn btn-link">Voltar ao inicio</a>
                            <a href="alterar.php" class="btn btn-link">Alterar mais</a>
