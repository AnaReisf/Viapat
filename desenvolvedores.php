...
<div class="row mb-2">
    <div class="col-md-8">
      ...
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="background-color: #800000; color:white" >
        <div class="col p-4 d-flex flex-column position-static">
          <h3 class="mb-0">Fatec Mococa</h3>
          <br>
          <p class="card-text mb-auto">Telefone para contato:(19) 3656-5559 / 3665-5079 / 3665-6005</p>
          <p class="card-text mb-auto">Site: https://www.fatecmococa.edu.br</p>
          <p class="card-text mb-auto">Fatec Mococa é uma instituição de ensino superior tecnológica vinculada ao CEETEPS, com cursos presenciais e a distância.</p>
          <p class="card-text mb-auto"> Av. Dr. Américo Pereira Lima, s/nº Jardim Lavínia - Mococa/SP - CEP: 13736-260</p>
      </div>
        </div>      
    </div>
</div>
